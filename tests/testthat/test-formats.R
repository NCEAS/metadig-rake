test_that("checking text formats works as expected", {
  ...
  expect_true(check_text_file_format(csvfile, delimiter = ",", header_lines = 2))
  ...
  expect_true(check_text_file_format(csvfile, delimiter = ",", header_lines = 0))
  ...
  expect_false(check_text_file_format(csvfile, delimiter = ",", header_lines = 1))
